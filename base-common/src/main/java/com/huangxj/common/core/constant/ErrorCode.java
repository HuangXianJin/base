...
public enum ErrorCode {
    ...
    VERIFICATION_CODE_ERROR(3006, "verification_code_error"),
    MINIAPP_LOGIN_ERROR(3007, "miniapp_lgoin_error"),
    /**
     * 请求错误
     */
    ...
    PRIMARY_KEY_IS_NULL(6000, "primary_key_is_null"),
    DATA_NOT_EXIST(6001, "data_not_exist");
