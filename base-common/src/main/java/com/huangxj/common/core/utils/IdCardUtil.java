...
public class IdCardUtil {
     ...
     * @param idcard 身份证
     * @param birthday 出生日期
     * @return 相符返回true，否则返回false
     */
    public static boolean validatedIdcardAndBirthday(String idcard, Date birthday) {
        if (idcard == null || "".equals(idcard) || birthday == null) {
            return false;
        }
        ...
        int s=15;
        if (idcard.length() == s) {
            idcardBirthday = idcard.substring(6, 12);
            birthdayStr = DateUtils.formatDate(birthday, "yyMMdd");
        }
        int s1=18;
        if(idcard.length()==s1) {
            idcardBirthday = idcard.substring(6, 14);
            birthdayStr = DateUtils.formatDate(birthday, "yyyyMMdd");
        }
        return idcardBirthday.equals(birthdayStr);
    }
    ...
    /*public static void main(String[] args) throws Exception {
        ...
        //String idcard18 = "110101199003076050";//合法
        String idcard18 = "110101199103076050";//非法
        String idcard = "610**************";
        //脱敏身份证
        ...
        //身份证与出生日期相比对
        System.out.println(validatedIdcardAndBirthday(idcard18,"1991-03-07"));
    }*/
}
