<template>
  <div>
    <el-popover v-model="isShowSelect" placement="bottom-start" trigger="click">
      ...
      <el-tree v-if="isShowSelect" ref="tree" :show-checkbox="multiple" :expand-on-click-node="true" :default-expanded-keys="defaultExpandedKeys" :default-checked-keys="key" :default-expand-all="defaultExpandAll" :props="defaultProps" :data="treeData" :node-key="nodeKey"
highlight-current @node-click="handleNodeClick" @check="getKeys" />
    </el-popover>
  </div>
</template>
<script>
